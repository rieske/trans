...
TEST(LR1CanonicalCollection, computesCanonicalCollectionForTheGrammar) {
    ...
    EXPECT_THAT(state1.at(0).str(grammar), Eq("[ <__start__> -> <S> . , " + scanner::Token::END + " ]\n"));

    const auto& state2 = canonicalCollection.setOfItemsAtState(2);
    EXPECT_THAT(state2, SizeIs(3));
    EXPECT_THAT(state2.at(0).str(grammar), Eq("[ <S> -> <X> . <X> , " + scanner::Token::END + " ]\n"));
    EXPECT_THAT(state2.at(1).str(grammar), Eq("[ <X> -> . a <X> , " + scanner::Token::END + " ]\n"));
    EXPECT_THAT(state2.at(2).str(grammar), Eq("[ <X> -> . b , " + scanner::Token::END + " ]\n"));
    ...
    EXPECT_THAT(state5.at(0).str(grammar), Eq("[ <S> -> <X> <X> . , " + scanner::Token::END + " ]\n"));
    ...
    EXPECT_THAT(state7.at(0).str(grammar), Eq("[ <X> -> b . , " + scanner::Token::END + " ]\n"));
    ...
    EXPECT_THAT(state9.at(0).str(grammar), Eq("[ <X> -> a <X> . , " + scanner::Token::END + " ]\n"));
...
TEST(LALR1CanonicalCollection, computesCanonicalCollectionForTheGrammar) {
    ...
    EXPECT_THAT(state47.at(0).str(grammar), Eq("[ <X> -> b . , a b " + scanner::Token::END + " ]\n"));
    ...
    EXPECT_THAT(state89.at(0).str(grammar), Eq("[ <X> -> a <X> . , a b " + scanner::Token::END + " ]\n"));
