...
ParameterList::ParameterList(ParameterList* parameterList, ParseTreeNode* comma, ParameterDeclaration* parameterDeclaration) :
		NonterminalNode(ID, { parameterList, comma, parameterDeclaration }) {
