...
// After the operand is visited: diagnose function designator / incomplete / bit-field,
// otherwise fold. Always types the expression as size_t. Returns an error message or nullopt.
