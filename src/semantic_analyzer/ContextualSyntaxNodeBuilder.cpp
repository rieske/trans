...
ContextualSyntaxNodeBuilder::ContextualSyntaxNodeBuilder() {
	...
	nodeCreatorRegistry[TYPE_SPECIFIER][sequence { "int" }] = ContextualSyntaxNodeBuilder::doNothing;
	nodeCreatorRegistry[TYPE_SPECIFIER][sequence { "char" }] = ContextualSyntaxNodeBuilder::doNothing;
	nodeCreatorRegistry[TYPE_SPECIFIER][sequence { "void" }] = ContextualSyntaxNodeBuilder::doNothing;
	nodeCreatorRegistry[TYPE_SPECIFIER][sequence { "float" }] = ContextualSyntaxNodeBuilder::doNothing;
