...
ContextualSyntaxNodeBuilder::ContextualSyntaxNodeBuilder() {
    ...
    nodeCreatorRegistry[LogicalOrExpression::ID][sequence { LogicalAndExpression::ID }] = ContextualSyntaxNodeBuilder::backpatchExpression;
    ...
    nodeCreatorRegistry[AssignmentExpression::ID][sequence { LogicalOrExpression::ID }] = ContextualSyntaxNodeBuilder::backpatchExpression;
...
void ContextualSyntaxNodeBuilder::typeCast(AbstractSyntaxTreeBuilderContext& context) {
    context.popTerminal(); // )
    context.pushExpression(
            std::unique_ptr<Expression> { new TypeCast(context.popTypeSpecifier(), context.popExpression(), context.scope()) });
    context.popTerminal(); // (
}
